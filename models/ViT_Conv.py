...
class ViT(nn.Module):
    def __init__(self, image_size=32, patch_size=2, num_classes=10, channels=768, depth=12, heads=12, mlp_dim=128, dim_head = 64, emb_p_drop = 0., dropout = 0., emb_dropout = 0.):
